...
import { p as parseURL, k as encodePath, l as decodePath, e as createError$1, m as hasProtocol, n as isScriptProtocol, h as joinURL, w as withQuery, s as sanitizeStatusCode, o as getContext, $ as $fetch, q as createHooks, r as executeAsync, t as defu } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "service",
    path: "/service",
    component: () => import('./service-DUcCwALw.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-ClxQskPZ.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-D-haeSxx.mjs'));
